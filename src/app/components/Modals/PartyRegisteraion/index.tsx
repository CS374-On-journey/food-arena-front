...
export default function PartyRegisteraion({
  ...
  return (
    ...
    >
      ...
      {
            selectedParty?.picture_urls && selectedParty?.picture_urls.length > 0 ? 
                <SwiperBox>
                    <Swiper
                        spaceBetween={5}
                        slidesPerView={2.5}
                    ...
                    >
                        {
                            selectedParty?.picture_urls.map((item, idx, arr)=>{
                                return (
                                    <SwiperSlide key={idx}>
                                        <Photo image={item}/>
                                    </SwiperSlide>
          ...
          <Title>Name: <b>{selectedParty?.restaurant}</b></Title>
          <Title>Location: <b>{selectedParty?.address.readable} </b></Title>
